...
if ($action == 'aprovar' && !empty($id)) {
    ...
    header("Location: aprovacoes.php?type=$type");
    exit();
...
<body>
  ...
  <div class="container">
    <div class="tabs">
      <a href="aprovacoes.php?type=registro" class="<?php echo ($type=='registro') ? 'active' : ''; ?>">Registros</a>
      <a href="aprovacoes.php?type=ocorrencia" class="<?php echo ($type=='ocorrencia') ? 'active' : ''; ?>">Ocorrências</a>
    </div>
